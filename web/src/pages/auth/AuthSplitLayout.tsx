      ...
      sx={{
        ...
        background:
          theme.palette.mode === 'light'
            ? 'radial-gradient(circle at 20% 15%, rgba(14, 165, 233, 0.14), transparent 45%), radial-gradient(circle at 80% 85%, rgba(16, 185, 129, 0.12), transparent 40%)'
            : 'radial-gradient(circle at 20% 15%, rgba(6, 182, 212, 0.3), transparent 45%), radial-gradient(circle at 80% 85%, rgba(20, 184, 166, 0.24), transparent 40%)',
      }}
    >
      <Paper
        elevation={0}
      ...
      >
        <Box
          sx={{
            ...
            background:
              theme.palette.mode === 'light'
                ? 'linear-gradient(145deg, rgba(16, 185, 129, 0.09), rgba(14, 165, 233, 0.2))'
                : 'linear-gradient(145deg, rgba(6, 78, 59, 0.65), rgba(8, 47, 73, 0.55))',
