...
func defaultDocumentationFiles() []struct {
	...
	return []struct {
		...
		{Slug: "api-documentation", Title: "API Documentation", Path: "api-documentation.md", Order: 10},
		{Slug: "documentation-browser", Title: "Documentation Browser", Path: "documentation-browser.md", Order: 20},
		{Slug: "configuration", Title: "Configuration", Path: "configuration.md", Order: 30},
		{Slug: "configuration-reference", Title: "Configuration Reference", Path: "configuration-reference.md", Order: 40},
		{Slug: "module-registry", Title: "Module Registry", Path: "module-registry.md", Order: 50},
		{Slug: "error-handling", Title: "Error Handling", Path: "error-handling.md", Order: 60},
		{Slug: "password-reset-flow", Title: "Password Reset Flow", Path: "password-reset-flow.md", Order: 70},
		{Slug: "api-token-settings-ui", Title: "API Token Settings UI", Path: "api-token-settings-ui.md", Order: 80},
		{Slug: "api-token-bound-user-scope", Title: "API Token Bound User Scope", Path: "api-token-bound-user-scope.md", Order: 90},
		...
		{Slug: "request-delete-response-body-persistence", Title: "Request Delete and Response Body Persistence", Path: "request-delete-response-body-persistence.md", Order: 110},
		...
		{Slug: "sukumad-target-repo-structure", Title: "Sukumad Target Repo Structure", Path: "sukumad-target-repo-structure.md", Order: 180},
		{Slug: "sukumad-codex-development-plan", Title: "Sukumad Codex Development Plan", Path: "sukumad-codex-development-plan.md", Order: 190},
		{Slug: "sukumad-merge-map", Title: "Sukumad Merge Map", Path: "sukumad-merge-map.md", Order: 200},
		{Slug: "sukumad-addons", Title: "Sukumad Addons", Path: "sukumad-addons.md", Order: 210},
		{Slug: "sukumad-delivery-engine", Title: "Sukumad Delivery Engine", Path: "sukumad-delivery-engine.md", Order: 220},
		{Slug: "sukumad-dhis2-async-integration", Title: "Sukumad DHIS2 Async Integration", Path: "sukumad-dhis2-async-integration.md", Order: 230},
		{Slug: "sukumad-directory-ingestion", Title: "Sukumad Directory Ingestion", Path: "sukumad-directory-ingestion.md", Order: 240},
		{Slug: "sukumad-how-requests-are-processed", Title: "Sukumad Request Processing", Path: "sukumad-how-requests-are-processed.md", Order: 250},
		{Slug: "sukumad-operations-dashboard", Title: "Sukumad Operations Dashboard", Path: "sukumad-operations-dashboard.md", Order: 260},
		{Slug: "sukumad-rate-limiting-correction", Title: "Sukumad Rate Limiting Correction", Path: "sukumad-rate-limiting-correction.md", Order: 270},
		{Slug: "sukumad-request-payload-transport", Title: "Sukumad Request Payload Transport", Path: "sukumad-request-payload-transport.md", Order: 280},
		{Slug: "sukumad-workers", Title: "Sukumad Workers", Path: "sukumad-workers.md", Order: 290},
		{Slug: "sukumad-workers-async", Title: "Sukumad Workers Async", Path: "sukumad-workers-async.md", Order: 300},
		{Slug: "rapidex-migrations-ui-hookup", Title: "RapidEx Migration and UI Hookup", Path: "rapidex-migrations-ui-hookup.md", Order: 310},
		{Slug: "rapidex-orgunit-reporter-enrichment", Title: "RapidEx Org Unit and Reporter Enrichment", Path: "rapidex-orgunit-reporter-enrichment.md", Order: 320},
		{Slug: "rapidex-rapidpro-reporter-sync", Title: "RapidEx RapidPro Reporter Sync", Path: "rapidex-rapidpro-reporter-sync.md", Order: 330},
		{Slug: "rapidex-org-unit-scope", Title: "RapidEx Org-Unit Jurisdiction Scope", Path: "rapidex-org-unit-scope.md", Order: 340},
		{Slug: "reporter-group-catalog", Title: "Reporter Group Catalog", Path: "reporter-group-catalog.md", Order: 350},
		{Slug: "rapidex-reporter-broadcast-queue", Title: "RapidEx Reporter Broadcast Queue", Path: "rapidex-reporter-broadcast-queue.md", Order: 360},
		{Slug: "rapidex-dhis2-hierarchy-sync", Title: "RapidEx DHIS2 Hierarchy Refresh", Path: "rapidex-dhis2-hierarchy-sync.md", Order: 370},
		{Slug: "rapidex-webhook-request-queueing", Title: "RapidEx Webhook Request Queueing", Path: "rapidex-webhook-request-queueing.md", Order: 380},
	}
}
